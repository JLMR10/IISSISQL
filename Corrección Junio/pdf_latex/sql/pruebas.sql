...
EXECUTE PRUEBAS_PRODUCTO.inicializar();
COMMIT WORK;
EXECUTE PRUEBAS_PRODUCTO.insertar('Producto con IVA invalido','Chaleco de lana','por una gran disenadora','Jerseys',46.95,2,false);
EXECUTE PRUEBAS_PRODUCTO.insertar('Producto con categoria invalida','Chaleco de lana','por una gran disenadora','Ropa',46.95,0.21,false);
EXECUTE PRUEBAS_PRODUCTO.insertar('Producto con precio invalido','Chaleco de lana','por una gran disenadora','Jerseys',-2,0.21,false);
...
EXECUTE PRUEBAS_EMPLAZAMIENTO.inicializar();
COMMIT WORK;
EXECUTE PRUEBAS_EMPLAZAMIENTO.insertar('Emplazamiento con tipo invalido', 'Calle de la piruleta 25', 958632666,'Emplazamiento', false);
